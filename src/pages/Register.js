      ...
      <div className="auth-brand-panel">
        <div className="auth-brand-content">
          ...
          <div className="auth-brand-hero">
            ...
            <p>Join thousands of students who've already found their ideal career path with AI-powered guidance.</p>
          </div>
          <div className="auth-brand-features">
            {[
              { emoji: "✨", text: "Personalized career assessments" },
              { emoji: "📊", text: "Adaptive study plans" },
              { emoji: "🏆", text: "Track progress & earn streaks" },
            ].map((f, i) => (
      ...
      <div className="auth-form-panel">
        <div className="auth-form-wrapper">
          ...
          <div className="auth-social-buttons">
            <button type="button" className="auth-social-btn" onClick={() => handleSocialLogin("Google")} id="google-register-btn">
            ...
            <button type="button" className="auth-social-btn" onClick={() => handleSocialLogin("GitHub")} id="github-register-btn">
              ...
              {form.password.length > 0 && (
                <div className="auth-password-rules">
                  {PASSWORD_RULES.map((rule, i) => (
                    <div key={i} className={`auth-rule ${rule.test(form.password) ? "pass" : ""}`}>
