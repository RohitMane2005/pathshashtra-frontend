    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px 60px" }}>
        ...
        <div className="landing-features-grid" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
          {[
            { icon: <Brain size={20} />, title: "AI Career Quizss`", desc: "12 psychometric questions → personality profile, top career matches, salary insights, and action plan.", color: "var(--orange)" },
